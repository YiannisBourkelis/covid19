...
Route::get('/', function () { return redirect(route('show_travel_exclusion_form'));})->name('root_path');
...
Route::post('cyprus/forms/print/travel_exclusion', 'TravelExclusionController@print_travel_exclusion_form')->name('cyprus_print_travel_exclusion_form');
...
Route::get('cyprus/forms/create/travel_exclusion', 'TravelExclusionController@show_travel_exclusion_form')->name('cyprus_show_travel_exclusion_form');
