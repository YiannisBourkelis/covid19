...
@section('title-tag', 'COVID-19 - Δήλωση κατ’ εξαίρεση μετακίνησης πολιτών Κύπρου')
@section('description-meta-tag', 'Φόρμα για τη γρήγορη συμπλήρωση της δήλωσης κατ’ εξαίρεση μετακίνησης πολιτών. Εύκολη αποστολή sms για την βεβαίωση μετακίνησης')
