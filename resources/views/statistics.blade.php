...
@section('title-tag', 'Αναλυτικά στατιστικά της πανδημίας του COVID-19')
@section('description-meta-tag', 'Αναλυτικά στατιστικά COVID-19 για την Ιταλία, Ισπανία, Ελλάδα, Κύπρο και Τουρκία')
...
<script type="application/ld+json">
    {
      ...
      "@type" : "Article",
      "name" : "Στατιστικά",
      "image" : "https://covid19gr.files.wordpress.com/2020/04/covid-26-04-2020-02.png",
...
<img src="https://covid19gr.files.wordpress.com/2020/04/covid-26-04-2020-02.png" class="img-fluid" alt="Responsive image">
